...
При выполнении дз в период \[23.03.2022-10.05.2022\] для пунктов 1-2 засчитывается половина баллов (т.е. +(0.33 + 0.33)/2) , а для пункта 3 засчитывается **полный балл** (т.е. +0.34) в соответствии с критериями.
